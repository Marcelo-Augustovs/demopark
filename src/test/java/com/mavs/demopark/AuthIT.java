...
public class AuthIT {
    ...
    @Test
    public void autenticar_ComCredenciaisInvalidas_RetornarErroMessageComStatus400(){
    ...
    @Test
    public void autenticar_ComUsuarioInvalido_RetornarErroMessageComStatus422(){
        ErroMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void autenticar_ComPasswordInvalido_RetornarErroMessageComStatus422(){
        ErroMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
