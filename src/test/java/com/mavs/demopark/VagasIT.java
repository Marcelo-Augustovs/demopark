...
public class VagasIT {
    ...
    @Test
    public void criarVaga_ComUsuarioSemPermisao_RetornarErroMessage403(){
        testClient
                .post()
                .uri("api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient,"bia@email.com","123456"))
                .bodyValue(new VagaCreateDto("A-08","LIVRE"))
                .exchange()
    ...
    public void criarVaga_ComDadosInvalidos_RetornarErroMessageStatus422(){
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient,"ana@email.com","123456"))
                .bodyValue(new VagaCreateDto("A-012" ,"DESOCUPADO"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody()
                .jsonPath("status").isEqualTo(422)
    ...
    @Test
    public void buscarVaga_ComDadosValidos_RetornarLocationStatus200(){
        testClient
                .get()
    ...
    @Test
    public void buscarVaga_ComUsuarioSemPermisao_RetornarErroMessage403(){
        testClient
                .get()
                .uri("api/v1/vagas/{codigo}","A-01")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient,"bia@email.com","123456"))
    ...
    @Test
    public void buscarVaga_ComDadosInvalidos_RetornarErroMessageStatus404(){
        testClient
                .get()
